...
**Ação necessária:** 3. Para metodos de get all, pode deixar sem o include, deixar apenas nos metodos de get by id
...
fastify.register(cors, {
	origin:
		process.env.NODE_ENV === "production" ? ["https://syntaxwear.com.br", "https://admin.syntaxwear.com.br"] : true,
	credentials: true,
